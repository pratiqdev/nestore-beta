//~ FROM git:nestore:dev - originally included in src and provided with nestore

import React, { useState, useEffect, useRef } from 'react'
import nestore, { T_Nestore, T_NestoreOptions } from '../src/nestore'
import { persistAdapter } from '../src/mongoAdapter'
